...
const StudentDashboard = () => {
  ...
  return (
      ...
      <header className="flex justify-between items-center p-6 bg-opacity-60">
           ...
           <button onClick={handleLogout} className="relative border px-4 py-2 text-[#ff8500] before:content-[''] before:absolute before:bottom-0 before:left-0 before:border-b-[5px] before:border-b-[#ff8500] before:border-l-[5px] before:border-l-transparent before:w-[0.8rem] before:h-[0.6rem] before:rounded-br-[50%] before:translate-y-[1.5px] after:content-[''] after:absolute after:bottom-0 after:right-0 after:border-b-[5px] after:border-b-[#ff8500] after:border-r-[5px] after:border-r-transparent after:w-[0.8rem] after:h-[0.6rem] after:rounded-bl-[50%] after:translate-y-[1.5px] ">Log Out</button>
      ...
      <section className="text-center p-12 bg-opacity-40">
        ...
        >
          ...
          <section className="bg-black text-white p-12">
             <h3 className="text-3xl font-bold text-center mb-10 text-[#ff8500] ">Showcase Your Work, Track Your Progress!</h3>
             <div className="flex justify-around">
                <div className="relative group w-1/3">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#ff7e5f] via-[#feb47b] to-[#ff7e5f] rounded-xl blur transition duration-300 group-hover:blur-md"></div>
                        <button onClick={handleShowSubmitProjectPopUp} className="relative flex items-center justify-center w-full p-6 bg-gray-800 rounded-xl shadow-md text-white font-semibold transform transition duration-300 ease-in-out hover:scale-105">
                             Submit Project
                      </button>
                   </div>
                     <div className="relative group w-1/3">
                       <div className="absolute inset-0 bg-gradient-to-r from-[#ff7e5f] via-[#feb47b] to-[#ff7e5f] rounded-xl blur transition duration-300 group-hover:blur-md"></div>
                            <button onClick={handleViewSubmitedProjects} className="relative flex items-center justify-center w-full p-6 bg-gray-800 rounded-xl shadow-md text-white font-semibold transform transition duration-300 ease-in-out hover:scale-105">
                                  View Submitted Projects
                            </button>
                    </div>
                </div>
          </section>
           {showSubmitProjectPopUp && (<SubmitProjectPopUp setShowSubmitProjectPopUp={handleHideSubmitProjectPopUp}/>)}
    </div>
  );
};
